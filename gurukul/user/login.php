...
if(isset($_POST['login'])) 
  {
    ...
    $sql ="SELECT RollNumber,MobileNumber,Password,ID,Cid FROM tbluser WHERE (Email=:email || RollNumber=:rollmobilenum || MobileNumber=:rollmobilenum) and Password=:password";
...
<head>
    ...
    <title>Gurukul User : Login</title>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="../index.php"><span>Gurukul User</span></a>
                        </div>
                        <div class="login-form">
                            ...
                            <form method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Email or Mobile Number" required="true" name="email">
                                </div>
                                <div class="form-group">
