...
<head>
	<title>Gurukul classes | Home Page</title>
...
<body>
			...
			<header>
				...
				<div class="header-bottom-w3layouts">
					<div class="main-w3ls-logo">
						<h1><a href="index.php"><span class="fa fa-check-square-o" aria-hidden="true"></span>Gurukul Classes</a></h1>
					</div>
					<!-- navigation -->
	...
	<div class="testimonials-section">
		<div class="container">
			<h5 class="main-w3l-title">Notice By Gurukul Class</h5>
...
{               ?>
	...
	<div class="footer-agileits-w3layouts">
		<div class="container">
			<div class="btm-logo-w3ls">
				<h2><a href="index.html"><span class="fa fa-check-square-o" aria-hidden="true"></span>Gurukul Classes</a></h2>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
	<div class="copyright-w3layouts">
		<div class="container">
			<p>&copy; 2023 gurukul_classes . Online Gurukul Classroom | </p>
		</div>
	</div>
	<!-- //Footer -->
